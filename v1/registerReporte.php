...
if($_SERVER['REQUEST_METHOD']=='POST'){
	if(isset($_POST['fechaRegistro']) and 
		isset($_POST['horaRegistro']) and 
			isset($_POST['reporte'])){
		...
		$db->registrarReporte($obj->{'usu_ubicacion_hecho'}, $obj->{'usu_cual_lugar'}, $fecha, $obj->{'usu_nombre_victima'}, $obj->{'usu_apellido_victima'}, $obj->{'usu_asamblea'});
